            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-brand-50/30 transition-colors">
                    ...
                    <td class="px-5 py-3 font-semibold text-gray-800">
                        @if($payment->status === \App\Models\Payment::STATUS_PENDING && (float) $payment->amount <= 0)
            ...
            <div class="relative p-4 w-full max-w-lg max-h-full">
                <div class="relative bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <p class="text-sm text-center text-gray-500 mb-4">
                        ...
                        untuk booking {{ $payment->booking->code }}. Silakan cocokkan bukti transfer lalu isi nominal yang benar.
                    </p>
